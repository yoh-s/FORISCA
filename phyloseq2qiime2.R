#Using function phyloseq2qiime2 written by Dr. Christian Edwardson [Github link](https://github.com/cedwardson4/phyloseq-extras)
#This function takes a phyloseq object, determines if each of the slots (otu_table, tax_table, sam_data, phy_tree, refseqs) are
#present, and if so, writes them to a format that is importable by qiime2.
#(phyloseq)
#(biomformat)
#(ape)
#(Biostrings)
